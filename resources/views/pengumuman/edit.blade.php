...
@section('content')
  <div class="page-header mb-4">
    <h2 class="mb-1 fw-bold text-dark" style="letter-spacing: -0.5px;">Edit Pengumuman</h2>
    <p class="text-muted text-sm mb-0">Perbarui informasi surat edaran atau pengumuman sekolah.</p>
  </div>
          ...
          <form action="{{ route('pengumuman.update', $pengumuman->id_pengumuman) }}" method="POST">
            ...
            <div class="row">
              <div class="col-md-8 mb-3">
                ...
                <input type="text" name="judul" maxlength="50" class="form-control @error('judul') is-invalid @enderror" value="{{ old('judul', $pengumuman->judul) }}" placeholder="Contoh: Libur Bersama Idul Fitri">
                @error('judul')
              ...
              <div class="col-md-6 mb-3">
                ...
                <input type="date" name="tanggal" class="form-control @error('tanggal') is-invalid @enderror" value="{{ old('tanggal', $pengumuman->tanggal) }}">
                @error('tanggal')
                  <div class="invalid-feedback">{{ $message }}</div>
                @enderror
              </div>
              ...
              <div class="col-md-12 mb-3">
                ...
                <textarea name="isi" rows="6" class="form-control @error('isi') is-invalid @enderror" placeholder="Tuliskan isi pengumuman secara lengkap di sini...">{{ old('isi', $pengumuman->isi) }}</textarea>
                @error('isi')
                  <div class="invalid-feedback">{{ $message }}</div>
                @enderror
              </div>
